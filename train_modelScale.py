...
# data in/out
# beta_PiDiNet24 beta_PiDiNet30 beta_PiDiNet60 beta_PiDiNet120 beta_PiDiNet240
# the c could be modified by setting model = PiDiNet(inplane = 24)
out_dir = 'beta_PiDiNet24'
dataset = '../BetaBSDS'
